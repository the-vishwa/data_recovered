...
public class Equal_method_override {
	...
	public static void main(String[] args) {
		...
		System.out.println("----------------------");
		// case 3
		System.out.println(m2.equals(mm)); //  true // mhanje object same asel kiwa jar veg vegla obj asel 
		// tr data same asel ani euqal method override karun tase bz logic put kel asel method made
